...
export const Button = ({loading, label, onClick}) => {
    return (
        <button
            ...
            type="submit"
            className={`w-full text-white focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2
                ${loading 
        ...
        >
            {loading ? (
                <div role="status">
                    ...
                    {label==="Sign in" ? "Signing in..." : "Signing up..."}
                </div>
            ) : (
                label
            )}
